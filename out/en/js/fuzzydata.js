...
{ "title" : "9.6.0 April 02, 2020 ", 
"url" : "sysdig-agent-release-notes.html#UUID-edb7ca93-8ac0-76e7-f833-52803884228a_UUID-56dccfcf-12b3-fc1b-3a45-40ec3893c54c", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Release Notes \/ Sysdig Agent Release Notes \/ 9.6.0 April 02, 2020 ", 
"snippet" : "All the public-facing URLs that are pointed to https:\/\/s3.amazonaws.com\/download.draios.com\/ have been updated to point to https:\/\/download.sysdig.com\/ . Change the whitelisting firewall\/proxy setting based on download.draios.com to reflect download.sysdig.com . Otherwise, the agent install on Linux...", 
"body" : "All the public-facing URLs that are pointed to https:\/\/s3.amazonaws.com\/download.draios.com\/ have been updated to point to https:\/\/download.sysdig.com\/ . Change the whitelisting firewall\/proxy setting based on download.draios.com to reflect download.sysdig.com . Otherwise, the agent install on Linux will fail. " }, 
{ "title" : "Fixes ", 
"url" : "sysdig-agent-release-notes.html#UUID-edb7ca93-8ac0-76e7-f833-52803884228a_section-idm4576389783248031656881272406", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Release Notes \/ Sysdig Agent Release Notes \/ 9.6.0 April 02, 2020 \/ Fixes ", 
...
"snippet" : "You can access and set the scope of Overview in the Sysdig Monitor UI or with the URL: On-Prem : https:\/\/[ Sysdig URL ]\/#\/overview SAAS : https:\/\/app.sysdigcloud.com\/#\/overview Click Overview in the left navigation, then select one of the Kubernetes entities: Clusters Clusters Overview Nodes Namespa...", 
"body" : "You can access and set the scope of Overview in the Sysdig Monitor UI or with the URL: On-Prem : https:\/\/[ Sysdig URL ]\/#\/overview SAAS : https:\/\/app.sysdigcloud.com\/#\/overview Click Overview in the left navigation, then select one of the Kubernetes entities: Clusters Clusters Overview Nodes Namespaces Workloads " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with API ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with API \/ Instructions for SaaS ", 
"snippet" : ". . . ....", 
"body" : ". . . . " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with API \/ Instructions for On-Prem ", 
"snippet" : ". . . . Follow ....", 
"body" : ". . . . Follow . " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with API \/ Get Your External ID ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with API \/ Configure Role Delegation ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with API \/ Get Role ARN ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with API \/ Add the AWS Account ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with API \/ Additional Configuration for On-Prem ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with API \/ Additional Configuration for On-Prem \/ Set Up Resource Discovery ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Enable AWS Role Delegation with UI ", 
...
"body" : "Use the AWS option in the Settings menu to configure AWS role delegation. Log in to the Sysdig Monitor as an administrator and select  Settings . Click AWS . The AWS Account page is displayed. Click Add Accounts. The Identity Authentication page opens to the Role Delegation tab. Specify the following: Role ARN : The Role ARN associated with the role you have created for role delegation. The ID is available on the summary page of the role on the AWS console. For more information, see . AWS External ID : Ensure that AWS External ID is displayed on the page. SaaS: The AWS account ID is 273107874544. On-Prem: Customer-specific. Click Save . " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ General Guidelines for Using the Data API ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ REST Resource: Data ", 
"snippet" : "See for generic conventions and authentication. Sysdig REST API Conventions...", 
"body" : "See for generic conventions and authentication. Sysdig REST API Conventions " }, 
{ "title" : "Request Variables ", 
"url" : "working-with-the-data-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4573163323404831663426218882", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ REST Resource: Data \/ Request Variables ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ REST Resource: Data \/ Response Variables ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ REST Resource: Data \/ Sample Request and Response ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ Python Script Library for Data API ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ Python Script Library for Data API \/ Function: sysdig_api.get_data ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ Python Script Library for Data API \/ Arguments ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ Python Script Library for Data API \/ Successful Return Value ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ Python Script Library for Data API \/ Sample Script ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ Guidelines for Using Data API ", 
"snippet" : "...", 
"body" : "" }, 
{ "title" : "General Guidelines ", 
"url" : "guidelines-for-using-data-api.html#UUID-bf307ad3-0abb-37a5-79b8-8fdaea758550_section-idm4573163248510431689529854398", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ Guidelines for Using Data API \/ General Guidelines ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Working with the Data API \/ Guidelines for Using Data API \/ Database Rate Limit ", 
