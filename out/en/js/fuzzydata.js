...
"snippet" : "Sysdig Platform supports disabling password-based authentication on both SaaS and on-prem deployments. As an administrator (super administrator for on-prem), you can use an API to achieve it. turn off password-based login....", 
"body" : "Sysdig Platform supports disabling password-based authentication on both SaaS and on-prem deployments. As an administrator (super administrator for on-prem), you can use an API to achieve it. turn off password-based login. " }, 
...
"body" : "You can set up a custom Amazon S3 compatible storage, such as Minio or IBM Cloud Object Storage , for storing Captures in a Sysdig on-premises deployment. The capture storage location can be used for both Sysdig Monitor and Sysdig Secure. This is an API-only functionality and currently, no UI support is available. You must configure the Secret , Deployment Descriptors , and ConfigMap files in your Kubernetes installation in order for this configuration to work. " }, 
{ "title" : "Prerequisites ", 
...
"body" : "Ensure that AWS-client compatible credentials used for authentication are present in the environment. The credentials are typically set up on the deployment itself. For example, Using HMAC Credentials explains how to configure credentials on IBM Cloud. Credentials can be configured using several approaches, such as: Environment variable Java system properties Instance profile credentials delivered through the Amazon EC2 metadata service (recommended if the installation is running on AWS) This topic discusses setting up authentication using environment variables on a Kubernetes installation. Ensure that the list, get, and put operations are functional on the S3 bucket that you wish to use. Confirm this by using the S3 native tools, for example, as described in AWS CLI for IBM Cloud. " }, 
{ "title" : "Configure Credentials ", 
"url" : "storage--configure-options-for-capture-files.html#UUID-56022a85-9335-796c-6cc9-dbf4f5094b4b_section-idm4623770041379231618721245279", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure Custom S3 Endpoint \/ Configure Credentials ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure Custom S3 Endpoint \/ Edit ConfigMap ", 
"snippet" : "Update sysdigcloud-config so that collectors, workers, and the API server are aware of the custom endpoint configuration. Append the following flags to the API, collector, and worker keys: -Ddraios.sysdig.s3.enabled=true -Ddraios.sysdig.s3.bucket=< bucket_name > Replace < bucket_name > with your S3 ...", 
"body" : "Update sysdigcloud-config so that collectors, workers, and the API server are aware of the custom endpoint configuration. Append the following flags to the API, collector, and worker keys: -Ddraios.sysdig.s3.enabled=true -Ddraios.sysdig.s3.bucket=< bucket_name > Replace < bucket_name > with your S3 bucket name. The keys to be used in the ConfigMap are: sysdigcloud.jvm.api.options sysdigcloud.jvm.collector.options sysdigcloud.jvm.worker.options Restart collectors, workers, and the API server. " }, 
{ "title" : "Edit Deployment Descriptors ", 
"url" : "storage--configure-options-for-capture-files.html#UUID-56022a85-9335-796c-6cc9-dbf4f5094b4b_section-idm4479625700936031644617745169", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure Custom S3 Endpoint \/ Edit Deployment Descriptors ", 
"snippet" : "Add the new environment variable, AWS_S3_ENDPOINT , to the following deployment descriptors: deployment\/sysdigcloud-worker deployment\/sysdigcloud-api deployment\/sysdigcloud-collector Set its value to the custom S3 endpoint in the following format: - name: AWS_S3_ENDPOINT value: <custom-S3-endpoint> ...", 
"body" : "Add the new environment variable, AWS_S3_ENDPOINT , to the following deployment descriptors: deployment\/sysdigcloud-worker deployment\/sysdigcloud-api deployment\/sysdigcloud-collector Set its value to the custom S3 endpoint in the following format: - name: AWS_S3_ENDPOINT\n value: <custom-S3-endpoint> The endpoints vary depending on the type of deployment. For compatible storage or on-prem installation, see the particular installation documentation. For example: Minio: The endpoint depends on the host and host port of the installation. IBM: See Endpoints and storage locations . Restart collectors, workers, and the API server to apply the changes. " }, 
...
"snippet" : "When first logging in to the Sysdig Monitor UI, the Welcome Wizard includes an option to integrate your AWS account to collect CloudWatch metrics. If you want to use an implicit key, you should skip this page in the Wizard. See Implicit Key Option for details....", 
"body" : "When first logging in to the Sysdig Monitor UI, the Welcome Wizard includes an option to integrate your AWS account to collect CloudWatch metrics. If you want to use an implicit key, you should skip this page in the Wizard. See Implicit Key Option for details. " }, 
...
{ "title" : "Integration Steps (Manual Option) ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Manual Option) ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Manual Option) \/ In AWS ", 
"snippet" : "...", 
"body" : "" }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Manual Option) \/ In AWS \/ Create an IAM Policy for Sysdig Access ", 
"snippet" : "You could use the existing IAMReadOnly policy instead, but creating a Sysdig-specific policy provides more granular access control, activity can be easily distinguished in CloudTrail, and it is considered best practice. In AWS, select IAM and create a policy to be used for Sysdig. (Sample policy nam...", 
"body" : "You could use the existing IAMReadOnly policy instead, but creating a Sysdig-specific policy provides more granular access control, activity can be easily distinguished in CloudTrail, and it is considered best practice. In AWS, select IAM and create a policy to be used for Sysdig. (Sample policy name: SysdigMonitorPolicy. ) Using the JSON editor view, copy\/paste the Sysdig-specific policy code into the new policy and save it. You can review the policy in the Visual Editor. When reviewing the completed policy in the Visual editor, you should see something like: " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Manual Option) \/ In AWS \/ Create an IAM User and Grant Programmatic Access ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Manual Option) \/ In the Sysdig Monitor UI ", 
"snippet" : "...", 
"body" : "" }, 
{ "title" : "Enter Access Key and Secret Key ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Manual Option) \/ In the Sysdig Monitor UI \/ Enter Access Key and Secret Key ", 
"snippet" : "Log in to Sysdig Monitor or Sysdig Secure as administrator and select Settings. Select AWS. Add an account by entering the User Access Key and Secret Key and clicking Save . The Credentials will be listed with a Status of OK checked. Should an Error occur instead, double-check the credentials entere...", 
"body" : "Log in to Sysdig Monitor or Sysdig Secure as administrator and select Settings. Select AWS. Add an account by entering the User Access Key and Secret Key and clicking Save . The Credentials will be listed with a Status of OK checked. Should an Error occur instead, double-check the credentials entered. Mis-typing is the most common cause of error. " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Manual Option) \/ In the Sysdig Monitor UI \/ Enable CloudWatch Integration ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Manual Option) \/ Refetch Credentials ", 
...
{ "title" : "Integration Steps (Implicit Key Option, On-Prem Only) ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Implicit Key Option, On-Prem Only) ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Implicit Key Option, On-Prem Only) \/ Use Implicit Key ", 
"snippet" : "...", 
"body" : "" }, 
{ "title" : "Prerequisites ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Implicit Key Option, On-Prem Only) \/ Use Implicit Key \/ Prerequisites ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Implicit Key Option, On-Prem Only) \/ Use Implicit Key \/ Kubernetes ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integration Steps (Implicit Key Option, On-Prem Only) \/ Use Implicit Key \/ Replicated ", 
