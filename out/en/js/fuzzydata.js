...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Monitor \/ Key Components \/ Overview Overview ", 
...
"snippet" : "Sysdig Monitor's basic data retention values are as follows: 10 second timeline retained for 4 hours 1 minute timeline retained for 2 days 10 minute timeline retained for 2 weeks 1 hour timeline retained for 2 months 1 day timeline retained for 15 months Different pricing plans may have different se...", 
"body" : "Sysdig Monitor's basic data retention values are as follows: 10 second timeline retained for 4 hours 1 minute timeline retained for 2 days 10 minute timeline retained for 2 weeks 1 hour timeline retained for 2 months 1 day timeline retained for 15 months Different pricing plans may have different settings. These will be defined in the Sysdig license agreement. When a host or instance is no longer monitored (i.e. when an agent is uninstalled), the historical data continues to be retained for the stated times. If required, it is possible to change the standard data retention settings using Sysdig's REST API. A Sysdig support team or professional services member should assist, as there are a variety of storage and timeline implications to consider before making such a change. Get Help Using Sysdig Support " }, 
...
"body" : "Before using Kubernetes resource metrics, review their compatibility with Sysdig components. The newly supported Kubernetes metrics are not available to older versions of Sysdig Agent. Note also that you must edit the agent config file, dragent.yaml, to enable these metrics. See Enable Kube State Metrics Collection with K8s_extra_resources . Enable Kube State Metrics Metric Name Agent Platform PVC metrics 0.89.3 and beyond Release 2172 Resource Quota metrics 0.87.1 and beyond Release 2172 HPA metrics 0.79.0 and beyond Release 2172 " }, 
...
"snippet" : "The current number of replicas of pods managed by the Horizontal Pod Autoscaler . Metric Type: Guage Segmented by: kubernetes.hpa.name kubernetes.cluster.id kubernetes.cluster.name kubernetes.namespace.name...", 
"body" : "The current number of replicas of pods managed by the Horizontal Pod Autoscaler . Metric Type: Guage Segmented by: kubernetes.hpa.name kubernetes.cluster.id kubernetes.cluster.name kubernetes.namespace.name " }, 
...
"snippet" : "The desired number of replicas of pods managed by the Horizontal Pod Autoscaler . Metric Type: Guage Segmented by: kubernetes.hpa.name kubernetes.cluster.id kubernetes.cluster.name kubernetes.namespace.name...", 
"body" : "The desired number of replicas of pods managed by the Horizontal Pod Autoscaler . Metric Type: Guage Segmented by: kubernetes.hpa.name kubernetes.cluster.id kubernetes.cluster.name kubernetes.namespace.name " }, 
...
"snippet" : "The New Dashboard is based around time. After a query has been executed, Sysdig Monitor polls the infrastructure data every 10 seconds and refreshes the metrics on the Dashboard panel. You select how to view this gathered data by choosing a Preset interval and a time Range....", 
"body" : "The New Dashboard is based around time. After a query has been executed, Sysdig Monitor polls the infrastructure data every 10 seconds and refreshes the metrics on the Dashboard panel. You select how to view this gathered data by choosing a Preset interval and a time Range. " }, 
{ "title" : "Presets ", 
...
"body" : "Each type of visualization has different settings and the query fields are determined by the type. For demonstration purposes, this topic explains the steps to create a Line chart. On the  Dashboards  tab, click Add dashboard . Click Beta Dashboard . Clicking Beta Dashboard opens a default beta dashboard for the avg(avg(cpu.used.percent)) metrics. Select a visualization type. For more information, see . Select the appropriate time presets from the time navigation. Select a metric as follows: Specify Time Aggregation and Group Rollup . Specify the display text in the Display field. The text appears as a title for the legend: Specify an appropriate segmentation: You can enter the number of entities and the order in which they are displayed in the legend. Not applicable to Number panels. Specify the scope for the dashboard you are creating. You can either choose to inherit the dashboard scope as it is or apply the scope to only a set of selected entities. Specify the unit of scale and the display format for Y-Axis. Applicable only to Timeseries panels. Optionally, compare the data against historical data. When segmentation is applied, comparing metrics against historical data is not supported. " }, 
...
"body" : "The Number panel displays a metric that can be represented by a single number, along with optional functionality to compare the current value to historical values. Use the Number panel when the number is the most important aspect of the metric you're trying to display, such as unique visitors to a website. For information on configuring a panel, see . " }, 
{ "title" : "Major Features ", 
"url" : "number-panel.html#UUID-b9692201-b425-a49d-d172-a50d6914af47_section-idm4634811503772831644524018147", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Monitor \/ Dashboards \/ New Dashboards \/ Types of Panels \/ Number Panel \/ Major Features ", 
"snippet" : "The default preset for the Number visualization is 1 hour. The global default values for the threshold are overridable. The new value can be reset back to the global default. A comparison between two threshold values determines color-coding directions. The Compare To functionality can be toggled bet...", 
"body" : "The default preset for the Number visualization is 1 hour. The global default values for the threshold are overridable. The new value can be reset back to the global default. A comparison between two threshold values determines color-coding directions. The Compare To functionality can be toggled between enabled and disabled. When the Compare To value is set, the preview is updated accordingly showing the comparison value and an arrow denoting the metric has increased or decreased. The unit displayed for Thresholds is determined by the query. " }, 
{ "title" : "Toplist ", 
"url" : "toplist.html", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Authentication and Authorization (On-Prem Options) \/ Disable Password Authentication ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Authentication and Authorization (On-Prem Options) \/ Disable Password Authentication \/ SaaS Deployments ", 
"snippet" : "As an administrator, perform the following: Get the Sysdig Platform settings: GET https:\/\/app.sysdigcloud.com\/api\/auth\/settings\/ Find the ID of the active SSO setup: GET https:\/\/app.sysdigcloud.com\/api\/auth\/settings\/active Retrieve the specific settings associated with the SSO setup: GET https:\/\/app...", 
"body" : "As an administrator, perform the following: Get the Sysdig Platform settings: GET https:\/\/app.sysdigcloud.com\/api\/auth\/settings\/ Find the ID of the active SSO setup: GET https:\/\/app.sysdigcloud.com\/api\/auth\/settings\/active Retrieve the specific settings associated with the SSO setup: GET https:\/\/app.sysdigcloud.com\/api\/auth\/settings\/{id} The setting is displayed in a JSON file. In the JSON file, change the following from false to true: settings\/forbidPasswordLogin: True Update the setting with a request to the same URL with the same JSON, with the changed parameter. URL depends on the type of deployment. PUT https:\/\/app.sysdigcloud.com\/api\/auth\/settings\/{id} " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Authentication and Authorization (On-Prem Options) \/ Disable Password Authentication \/ On-Prem Deployments ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Authentication and Authorization (On-Prem Options) \/ Disable Password Authentication \/ Migrating from the ConfigMap Method ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files ", 
"snippet" : "The Sysdig Capture feature allows you to record detailed system trace data via remote connection from any of your agent-installed hosts. In SaaS installations, by default, this data will be stored on Sysdig's secure Amazon S3 storage location, under a separate partition for your account. In on-premi...", 
"body" : "The Sysdig Capture feature allows you to record detailed system trace data via remote connection from any of your agent-installed hosts. In SaaS installations, by default, this data will be stored on Sysdig's secure Amazon S3 storage location, under a separate partition for your account. In on-premises installations, by default, the data will be stored in the Cassandra database. This page describes two custom alternatives: using an AWS S3 bucket (available for SaaS and on-prem) and using custom S3 storage (on-prem only). " }, 
{ "title" : "Configure AWS S3 Storage ", 
"url" : "storage--configure-options-for-capture-files.html#UUID-56022a85-9335-796c-6cc9-dbf4f5094b4b_section-idm4634811412995231644359256724", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure AWS S3 Storage ", 
"snippet" : "To configure this option, use the fields provided Sysdig Settings UI and then append some code to the IAM Policy you created in AWS for Sysdig integration....", 
"body" : "To configure this option, use the fields provided Sysdig Settings UI and then append some code to the IAM Policy you created in AWS for Sysdig integration. " }, 
{ "title" : "Prerequisites ", 
"url" : "storage--configure-options-for-capture-files.html#UUID-56022a85-9335-796c-6cc9-dbf4f5094b4b_UUID-5b1deeb2-c24e-d5e3-30d4-95946b68feae", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure AWS S3 Storage \/ Prerequisites ", 
"snippet" : "Your AWS account must be integrated with Sysdig, but the CloudWatch feature is not required to be enabled. See AWS: Integrate AWS Account and CloudWatch Metrics (Optional) Have your S3 bucket name available....", 
"body" : "Your AWS account must be integrated with Sysdig, but the CloudWatch feature is not required to be enabled. See AWS: Integrate AWS Account and CloudWatch Metrics (Optional) Have your S3 bucket name available. " }, 
{ "title" : "On the Sysdig Monitor Side ", 
"url" : "storage--configure-options-for-capture-files.html#UUID-56022a85-9335-796c-6cc9-dbf4f5094b4b_UUID-8ad83760-3ff7-6786-6e73-3f6651797e71", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure AWS S3 Storage \/ On the Sysdig Monitor Side ", 
"snippet" : "Log in as Administrator to Sysdig Monitor. From the Selector button in the lower-left navigation, select Settings >Sysdig Storage. Enable the Use a custom S3 bucket toggle and enter your AWS S3 bucket name ....", 
"body" : "Log in as Administrator to Sysdig Monitor. From the Selector button in the lower-left navigation, select Settings >Sysdig Storage. Enable the Use a custom S3 bucket toggle and enter your AWS S3 bucket name . " }, 
{ "title" : "To Test: Capture a Trace File in Sysdig Monitor UI ", 
"url" : "storage--configure-options-for-capture-files.html#UUID-56022a85-9335-796c-6cc9-dbf4f5094b4b_UUID-d945112d-a666-539b-fae6-6f7bc24bed0c", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure AWS S3 Storage \/ To Test: Capture a Trace File in Sysdig Monitor UI ", 
...
{ "title" : "Configure Custom S3 Endpoint ", 
"url" : "storage--configure-options-for-capture-files.html#UUID-56022a85-9335-796c-6cc9-dbf4f5094b4b_UUID-48aa834c-77e0-27f9-7f33-d3de96ab70b5", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure Custom S3 Endpoint ", 
...
{ "title" : "Prerequisites ", 
"url" : "storage--configure-options-for-capture-files.html#UUID-56022a85-9335-796c-6cc9-dbf4f5094b4b_section-idm4612463202284831618648578205", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure Custom S3 Endpoint \/ Prerequisites ", 
"snippet" : "Your on-premise installation is Installer -based. If you have installed Sysdig Platform manually and you want to configure custom S3 buckets to store your capture files, contact your Sysdig representative. Installer (KubernetesOpenShift Ensure that AWS-client compatible credentials used for authenti...", 
"body" : "Your on-premise installation is Installer -based. If you have installed Sysdig Platform manually and you want to configure custom S3 buckets to store your capture files, contact your Sysdig representative. Installer (KubernetesOpenShift Ensure that AWS-client compatible credentials used for authentication are present in the environment. Ensure that the list, get, and put operations are functional on the S3 bucket that you wish to use. Confirm this by using the S3 native tools, for example, as described in AWS CLI for IBM Cloud. " }, 
{ "title" : "Configure Installer ", 
"url" : "storage--configure-options-for-capture-files.html#UUID-56022a85-9335-796c-6cc9-dbf4f5094b4b_section-idm4623774678017631618727196925", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ Storage: Configure Options for Capture Files \/ Configure Custom S3 Endpoint \/ Configure Installer ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) ", 
...
{ "title" : "Two Entry Points in the Sysdig UI ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Two Entry Points in the Sysdig UI ", 
"snippet" : "The Sysdig interface prompts you to perform this integration from two different places: the Welcome Wizard or the administrator's Settings menu....", 
"body" : "The Sysdig interface prompts you to perform this integration from two different places: the Welcome Wizard or the administrator's Settings menu. " }, 
{ "title" : "Access from the Welcome Wizard ", 
"url" : "aws--integrate-aws-account-and-cloudwatch-metrics--optional-.html#UUID-7e90eaaa-8a1b-97f4-1ad9-433ae21db0ba_UUID-72ecc09b-26d6-c8a9-57f3-ffed5e86117f", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Two Entry Points in the Sysdig UI \/ Access from the Welcome Wizard ", 
"snippet" : "When first logging into the Sysdig Monitor UI, the Welcome Wizard includes an option to integrate your AWS account to collect CloudWatch metrics. If you want to use an implicit key, you should skip this page in the Wizard. See Implicit Key Option for details....", 
"body" : "When first logging into the Sysdig Monitor UI, the Welcome Wizard includes an option to integrate your AWS account to collect CloudWatch metrics. If you want to use an implicit key, you should skip this page in the Wizard. See Implicit Key Option for details. " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Two Entry Points in the Sysdig UI \/ Access from the Settings Menu ", 
"snippet" : "Once an agent has been installed, log in to Sysdig Monitor or Sysdig Secure as administrator to perform integration steps or review\/modify existing AWS settings. Log in to Sysdig Monitor or Sysdig Secure as administrator and select Settings. Choose AWS . An AWS page showing manual key integration, w...", 
"body" : "Once an agent has been installed, log in to Sysdig Monitor or Sysdig Secure as administrator to perform integration steps or review\/modify existing AWS settings. Log in to Sysdig Monitor or Sysdig Secure as administrator and select Settings. Choose AWS . An AWS page showing manual key integration, with access key and secret key fields displayed. NOTE: If there is no AWS integration yet then click on ADD YOUR AWS ACCOUNT and provide the access key and secret key\" " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Manually ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Manually \/ In AWS ", 
"snippet" : "...", 
"body" : "" }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Manually \/ In AWS \/ Create an IAM Policy for Sysdig Access ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Manually \/ In AWS \/ Create an IAM User and Grant Programmatic Access ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Manually \/ In the Sysdig Monitor UI ", 
"snippet" : "...", 
"body" : "" }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Manually \/ In the Sysdig Monitor UI \/ Enter the Access and Secret Key ", 
"snippet" : "Log in to Sysdig Monitor or Sysdig Secure as the administrator and select Settings . Select AWS . Add an account by entering the User Access Key and Secret Key and clicking Save . The Credentials will be listed with a Status of OK checked. Should an Error occur instead, double-check the credentials ...", 
"body" : "Log in to Sysdig Monitor or Sysdig Secure as the administrator and select Settings . Select AWS . Add an account by entering the User Access Key and Secret Key and clicking Save . The Credentials will be listed with a Status of OK checked. Should an Error occur instead, double-check the credentials entered. Mis-typing is the most common cause of errors. " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Manually \/ In the Sysdig Monitor UI \/ Enable CloudWatch Integration ", 
"snippet" : "Navigate to the AWS page in the Sysdig Monitor UI, if you are not already there. Toggle the CloudWatch Integration Status to Enabled . Sysdig Monitor will poll the CloudWatch API every five minutes. Note that this incurs additional charges from AWS....", 
"body" : "Navigate to the AWS page in the Sysdig Monitor UI, if you are not already there. Toggle the CloudWatch Integration Status to Enabled . Sysdig Monitor will poll the CloudWatch API every five minutes. Note that this incurs additional charges from AWS. " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Manually \/ Refetch Credentials ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Using the Implicit Key (On-Prem Only) ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Using the Implicit Key (On-Prem Only) \/ Use Implicit Key ", 
"snippet" : "...", 
"body" : "" }, 
{ "title" : "Prerequisites ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Using the Implicit Key (On-Prem Only) \/ Use Implicit Key \/ Prerequisites ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Using the Implicit Key (On-Prem Only) \/ Use Implicit Key \/ Kubernetes ", 
...
"body" : "Edit the config.yaml to add to the following entries (in the Data section of config.yaml ): sysdigcloud.jvm.api.options:\nsysdigcloud.jvm.worker.options:\nsysdigcloud.jvm.collector.options: If you are switching from manual to implicit keys, you must also restart the API, worker, and collector components. See for details. To Make Configuration Changes Enable Cloudwatch integration in the Sysdig UI. " }, 
{ "title" : "Replicated ", 
"url" : "aws--integrate-aws-account-and-cloudwatch-metrics--optional-.html#UUID-7e90eaaa-8a1b-97f4-1ad9-433ae21db0ba_UUID-f7c6c0a9-8cb9-6f97-2c20-f2642f03c839", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate AWS Account Using the Implicit Key (On-Prem Only) \/ Use Implicit Key \/ Replicated ", 
"snippet" : "In the Replicated Management Console, enter -Ddraios.providers.aws.implicitProvider=true in Sysdig Cloud application JVM options . If you have other settings in that field, separate the entries with a space. See also Replicated Advanced Settings Install with Replicated . If you are switching from ma...", 
"body" : "In the Replicated Management Console, enter -Ddraios.providers.aws.implicitProvider=true in Sysdig Cloud application JVM options . If you have other settings in that field, separate the entries with a space. See also Replicated Advanced Settings Install with Replicated . If you are switching from manual keys, you must restart the backend components from the Replicated Management Console. Enable CloudWatch Integration in the Sysdig Monitor UI. " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Changing the AWS Services that are Polled ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Security Groups ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Retrieving CloudWatch Data for Particular AWS Regions ", 
"snippet" : "To enable metrics collection from only certain AWS regions in your environment, it is necessary to open a ticket with Sysdig Support. See Contact Support for details. Contact Support...", 
"body" : "To enable metrics collection from only certain AWS regions in your environment, it is necessary to open a ticket with Sysdig Support. See Contact Support for details. Contact Support " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Related Information ", 
"snippet" : "For information on the resulting AWS services visible in Sysdig Monitor, see the AWS-related information in the Metrics Dictionary (also available from within the Sysdig Monitor UI). AWS For information on how licensing affects AWS service views, see AWS Services Licensing . AWS Services Licensing...", 
"body" : "For information on the resulting AWS services visible in Sysdig Monitor, see the AWS-related information in the Metrics Dictionary (also available from within the Sysdig Monitor UI). AWS For information on how licensing affects AWS service views, see AWS Services Licensing . AWS Services Licensing " }, 
{ "title" : "IAM Policy Code to Use ", 
"url" : "iam-policy-code-to-use.html", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ IAM Policy Code to Use ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation ", 
"snippet" : "This section describes how to use an Amazon Web Service (AWS) role to delegate access to AWS resources, such as CloudWatch metrics and S3 bucket, that are in a different AWS account. Setting up cross-account access through roles eliminates the need to create individual IAM users in each account. In ...", 
"body" : "This section describes how to use an Amazon Web Service (AWS) role to delegate access to AWS resources, such as CloudWatch metrics and S3 bucket, that are in a different AWS account. Setting up cross-account access through roles eliminates the need to create individual IAM users in each account. In addition, users don't have to sign out of one account and sign in to another in order to access resources in different AWS accounts. Role delegation is an alternative to the existing integration method using the access keys. This method is considered secure as sharing developer access keys with third-parties is not recommended by Amazon. " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Prerequisites and Guidelines ", 
"snippet" : "This topic assumes that you have the following ready and you are familiar with AWS. Sysdig Monitor API Token External ID API endpoint. In this topic, it is referred to as {{host}} SaaS: The endpoint is https:\/\/app.sysdigcloud.com for Monitor and https:\/\/secure.sysdig.com for Secure. On-Prem: Depends...", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Instructions for SaaS ", 
"snippet" : ". . . ....", 
"body" : ". . . . " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Instructions for On-Prem ", 
"snippet" : ". . . . Follow ....", 
"body" : ". . . . Follow . " }, 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Get Your External ID ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Configure Role Delegation ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Get Role ARN ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Add the AWS Account ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Additional Configuration for On-Prem ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Additional Configuration for On-Prem \/ Example: Set Environment Variables on a Kubernetes Installation ", 
...
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Platform \/ On-Premises Deployments \/ AWS: Integrate AWS Account and CloudWatch Metrics (Optional) \/ Integrate with AWS Role Delegation \/ Additional Configuration for On-Prem \/ Set Up Resource Discovery ", 
...
"url" : "sysdig-developer.html", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer ", 
...
"body" : "Sysdig provides some REST APIs and a Python Script Library to extend the functions of the Sysdig Monitor and Secure capabilities over a public API. Sysdig also provides a basic CLI for both products. This section covers: Sysdig CLI for Sysdig Monitor and Secure : Learn the basic commands and operations included in the CLI for both Sysdig Monitor and Sysdig Secure. Sysdig Python Client : Learn how to use the Python client library and a collection of Python sample scripts to expose and use some of the most common Sysdig API functions. Sysdig REST API: : Learn about the Sysdig REST API convention. Sysdig REST API Conventions : Audit Sysdig Platform Learn how to view a log of user activities and modifications to the components in the system. Dashboard Scripts: : Learn how to programmatically interact with Sysdig Dashboards. Working with Dashboards " }, 
{ "title" : "Sysdig API ", 
"url" : "sysdig-api.html", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API ", 
"snippet" : "...", 
"body" : "" }, 
{ "title" : "Data API ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API ", 
"snippet" : "...", 
"body" : "" }, 
{ "title" : "About the Data API ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_UUID-6e1c2d60-58c7-8962-fbbe-4d35a9a78737", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ About the Data API ", 
"snippet" : "The Data API provides access to metrics data stored in the Sysdig datastores. The data stores receive the scraped data from the agent through the collector service. Data access is optimized through indexes, caches, and pre-calculated data for high-speed retrieval. The only mode of accessing metrics ...", 
"body" : "The Data API provides access to metrics data stored in the Sysdig datastores. The data stores receive the scraped data from the agent through the collector service. Data access is optimized through indexes, caches, and pre-calculated data for high-speed retrieval. The only mode of accessing metrics is JSON. " }, 
{ "title" : "The Data Model ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4622762842291231680824851758", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ About the Data API \/ The Data Model ", 
"snippet" : "Sysdig stores data in Cassandra database tables. The key columns contain timestamps and labels, whereas the value columns list the metrics scraped by the agent. You use data aggregation methods to present it in a summarized method for further analysis. Sysdig employs two forms of aggregation for met...", 
"body" : "Sysdig stores data in Cassandra database tables. The key columns contain timestamps and labels, whereas the value columns list the metrics scraped by the agent. You use data aggregation methods to present it in a summarized method for further analysis. Sysdig employs two forms of aggregation for metrics: time aggregation and group aggregation. See for more information. " }, 
{ "title" : "Data Sampling and Timelines ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4622762841467231680849158567", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ About the Data API \/ Data Sampling and Timelines ", 
"snippet" : "Sampling is the mechanism of collecting a subset of data for analyzing. Sysdig agents collect 1-second samples and report data at 10-second resolution. Therefore, the data resolution, natively, is 10 seconds. The workers aggregate and load 6 such samples every 1 minute to create a 1-minute snapshot....", 
"body" : "Sampling is the mechanism of collecting a subset of data for analyzing. Sysdig agents collect 1-second samples and report data at 10-second resolution. Therefore, the data resolution, natively, is 10 seconds. The workers aggregate and load 6 such samples every 1 minute to create a 1-minute snapshot. Similarly, to optimize API queries, snapshots at different lower data resolution (10 minutes, 1 hour, and 1 day) are created and stored in the Cassandra data store. Sysdig exposes data available at different resolutions via timelines, each for a specific data resolution. Each one has different data retention periods. To learn more about aggregation techniques, see . " }, 
{ "title" : "REST Resource: Data ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4568235559315231663425615351", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ REST Resource: Data ", 
"snippet" : "...", 
"body" : "" }, 
{ "title" : "Sample Request and Response ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4568235558164831663462253078", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ REST Resource: Data \/ Sample Request and Response ", 
...
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4573163323404831663426218882", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ REST Resource: Data \/ Request Variables ", 
...
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4614248715992031665188626325", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ Python Script Library for Data API ", 
"snippet" : "Sysdig Python client for interacting with the Data API....", 
"body" : "Sysdig Python client for interacting with the Data API. " }, 
{ "title" : "Function: sysdig_api.get_data ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4604915834113631665212450204", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ Python Script Library for Data API \/ Function: sysdig_api.get_data ", 
...
{ "title" : "Arguments ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4575661977008031665273375539", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ Python Script Library for Data API \/ Arguments ", 
...
{ "title" : "Success Return Value ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4557406959460831665276402324", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ Python Script Library for Data API \/ Success Return Value ", 
"snippet" : "Returns the requested metrics data in a JSON file....", 
"body" : "Returns the requested metrics data in a JSON file. " }, 
{ "title" : "Sample Script ", 
"url" : "sysdig-api.html#UUID-fdadbabe-852a-6516-38ee-e6cc019ffe1f_section-idm4557406962300831665195976613", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ Python Script Library for Data API \/ Sample Script ", 
...
"url" : "sysdig-api.html#UUID-bf307ad3-0abb-37a5-79b8-8fdaea758550", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ Guidelines for Using Data API ", 
"snippet" : "...", 
"body" : "" }, 
{ "title" : "General Guidelines ", 
"url" : "sysdig-api.html#UUID-bf307ad3-0abb-37a5-79b8-8fdaea758550_section-idm4573163248510431689529854398", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ Guidelines for Using Data API \/ General Guidelines ", 
...
"url" : "sysdig-api.html#UUID-bf307ad3-0abb-37a5-79b8-8fdaea758550_section-idm4639882242960031689528881455", 
"breadcrumbs" : "Staging Sysdig Documentation \/ Sysdig Developer \/ Sysdig API \/ Data API \/ Guidelines for Using Data API \/ Database Rate Limit ", 
