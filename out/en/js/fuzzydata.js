...
"snippet" : "Update sysdigcloud-config so that collectors, workers, and the API server are aware of the custom endpoint configuration. Append the following flags to API, Collector, and Worker keys: -Ddraios.sysdig.s3.enabled=true -Ddraios.sysdig.s3.bucket=< bucket_name > Replace < bucket_name > with your S3 buck...", 
"body" : "Update sysdigcloud-config so that collectors, workers, and the API server are aware of the custom endpoint configuration. Append the following flags to API, Collector, and Worker keys: -Ddraios.sysdig.s3.enabled=true -Ddraios.sysdig.s3.bucket=< bucket_name > Replace < bucket_name > with your S3 bucket name. The keys in the ConfigMap are: sysdigcloud.jvm.api.options sysdigcloud.jvm.collector.options sysdigcloud.jvm.worker.options Restart collectors, workers, and the API server. " }, 
