...
"body" : "You can set up a custom Amazon S3 compatible storage, such as Minio or IBM Cloud Object Storage , for storing Captures in a Sysdig on-premises deployment. The capture storage location can be used for both Sysdig Monitor and Sysdig Secure. This is an API-only functionality and currently, no UI support is available. You must configure the Deployment Descriptors and Sysdig Installer files corresponding to your Kubernetes installation in order for this configuration to work. " }, 
{ "title" : "Prerequisites ", 
