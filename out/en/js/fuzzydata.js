...
"snippet" : "The number of all the running pods in a Namespace. The metric takes free pods also into account, that is, pods that are not belonging to any controller. Therefore, its value is not the sum of (statefulset|daemonset|deployment).pod.running.count . Metric Type: Gauge Segmented by: Namespace...", 
"body" : "The number of all the running pods in a Namespace. The metric takes free pods also into account, that is, pods that are not belonging to any controller. Therefore, its value is not the sum of (statefulset|daemonset|deployment).pod.running.count . Metric Type: Gauge Segmented by: Namespace " }, 
