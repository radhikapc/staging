 $(document).ready(function () {
  ...
  $( "<p class='intro-para'> We've just launched our new Doc site. You may encounter some broken links and missing images. We are actively working on it. <br />In the meantime, explore the site and let us know what you think. We value your feedback. Send your comments to doc-feedback@sysdig.com.</p>" ).insertAfter('.portal-search')
 });
